...
namespace Snapser.Model
{
    ...
    public partial class AcceptInviteRequest : IEquatable<AcceptInviteRequest>, IValidatableObject
    {
        ...
        public AcceptInviteRequest(string userId = default(string))
        {
            this.UserId = userId;
        }
        ...
        /// </summary>
        /// <value>ID of the user approving the request. The user must be the owner to approve. If using auth, this must match the user_id in the auth token</value>

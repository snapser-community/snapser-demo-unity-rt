...
namespace Snapser.Model
{
    ...
    public partial class IncrementScoreRequest : IEquatable<IncrementScoreRequest>, IValidatableObject
    {
        ...
        /// <param name="userMetadata">Metadata to be stored with the user (required).</param>
        ...
        {
            this.Delta = delta;
            // to ensure "userMetadata" is required (not null)
            if (userMetadata == null)
            {
                throw new ArgumentNullException("userMetadata is a required property for IncrementScoreRequest and cannot be null");
            }
        ...
        [DataMember(Name = "user_metadata", IsRequired = true, EmitDefaultValue = true)]

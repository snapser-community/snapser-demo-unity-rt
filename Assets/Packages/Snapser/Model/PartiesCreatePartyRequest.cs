...
{
    /// <summary>
    /// PartiesCreatePartyRequest
    /// </summary>
    [DataContract(Name = "partiesCreatePartyRequest")]
    public partial class PartiesCreatePartyRequest : IEquatable<PartiesCreatePartyRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public PartiesCreatePartyRequest(long maxPlayers = default(long), Object metadata = default(Object), string ownerId = default(string), Object ownerMetadata = default(Object), string partyName = default(string), Object searchProperties = default(Object), string status = default(string), string visibility = default(string))
        {
        ...
        /// </summary>
        /// <value>A Json document of metadata to be stored with the player that created the party</value>
        [DataMember(Name = "owner_metadata", EmitDefaultValue = false)]
        public Object OwnerMetadata { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PartiesCreatePartyRequest {\n");
            sb.Append("  MaxPlayers: ").Append(MaxPlayers).Append("\n");
            sb.Append("  Metadata: ").Append(Metadata).Append("\n");
            sb.Append("  OwnerId: ").Append(OwnerId).Append("\n");
            sb.Append("  OwnerMetadata: ").Append(OwnerMetadata).Append("\n");
        ...
        {
            return this.Equals(input as PartiesCreatePartyRequest);
        }

        /// <summary>
        /// Returns true if PartiesCreatePartyRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PartiesCreatePartyRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PartiesCreatePartyRequest input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.OwnerMetadata == input.OwnerMetadata ||
                    (this.OwnerMetadata != null &&
                    this.OwnerMetadata.Equals(input.OwnerMetadata))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.OwnerMetadata.GetHashCode();
                }

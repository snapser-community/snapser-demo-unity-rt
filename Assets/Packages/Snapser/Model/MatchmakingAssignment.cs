...
namespace Snapser.Model
{
    ...
    public partial class MatchmakingAssignment : IEquatable<MatchmakingAssignment>, IValidatableObject
    {
        ...
        /// </summary>
        [DataMember(Name = "lobby_id", EmitDefaultValue = false)]
        ...
        public bool Equals(MatchmakingAssignment input)
        {
            ...
            return 
                ...
                (
                    this.LobbyId == input.LobbyId ||
                    (this.LobbyId != null &&
                    this.LobbyId.Equals(input.LobbyId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.LobbyId.GetHashCode();
                }

...
namespace Snapser.Api
{
    ...
    public partial class LeaderboardsServiceApi : IDisposable, ILeaderboardsServiceApi
    {
        ...
        {
            Snapser.Client.ApiResponse<LeaderboardsGetScoresResponse> localVarResponse = await LeaderboardsGetScoresWithHttpInfoAsync(leaderboardName, range, count, token, userId, offset, withMetadata, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }

...
namespace Snapser.Api
{
    ...
    public interface IStatisticsServiceApiSync : IApiAccessor
    {
        ...
        /// <param name="keys">Name of the user statistic</param>
        /// <param name="token">User session token</param>
        /// <returns>StatisticsGetUserStatisticsResponse</returns>
        StatisticsGetUserStatisticsResponse GetBulkUserStatistics(string userId, string keys, string token);
        ...
        ApiResponse<StatisticsGetUserStatisticsResponse> GetBulkUserStatisticsWithHttpInfo(string userId, string keys, string token);
        /// <summary>
        /// User Statistic
        /// </summary>
        /// <remarks>
    ...
    public interface IStatisticsServiceApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<StatisticsGetUserStatisticsResponse> GetBulkUserStatisticsAsync(string userId, string keys, string token, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<StatisticsGetUserStatisticsResponse>> GetBulkUserStatisticsWithHttpInfoAsync(string userId, string keys, string token, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// User Statistic
        /// </summary>
        /// <remarks>
    ...
    public partial class StatisticsServiceApi : IDisposable, IStatisticsServiceApi
    {
        ...
        /// <summary>
        /// User Statistics Fetches multiple user statistic by user id and stat keys
        /// </summary>
        /// <exception cref="Snapser.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="userId">User ID of the user</param>
        /// <param name="keys">Name of the user statistic</param>
        /// <param name="token">User session token</param>
        /// <returns>StatisticsGetUserStatisticsResponse</returns>
        public StatisticsGetUserStatisticsResponse GetBulkUserStatistics(string userId, string keys, string token)
        {
            Snapser.Client.ApiResponse<StatisticsGetUserStatisticsResponse> localVarResponse = GetBulkUserStatisticsWithHttpInfo(userId, keys, token);
            return localVarResponse.Data;
        }
        ...
        /// <param name="token">User session token</param>
        /// <returns>ApiResponse of StatisticsGetUserStatisticsResponse</returns>
        public Snapser.Client.ApiResponse<StatisticsGetUserStatisticsResponse> GetBulkUserStatisticsWithHttpInfo(string userId, string keys, string token)
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
                throw new Snapser.Client.ApiException(400, "Missing required parameter 'userId' when calling StatisticsServiceApi->GetBulkUserStatistics");

            // verify the required parameter 'keys' is set
            if (keys == null)
                throw new Snapser.Client.ApiException(400, "Missing required parameter 'keys' when calling StatisticsServiceApi->GetBulkUserStatistics");

            // verify the required parameter 'token' is set
            if (token == null)
                throw new Snapser.Client.ApiException(400, "Missing required parameter 'token' when calling StatisticsServiceApi->GetBulkUserStatistics");
            ...
            localVarRequestOptions.PathParameters.Add("user_id", Snapser.Client.ClientUtils.ParameterToString(userId)); // path parameter
            localVarRequestOptions.QueryParameters.Add(Snapser.Client.ClientUtils.ParameterToMultiMap("", "keys", keys));
            localVarRequestOptions.HeaderParameters.Add("Token", Snapser.Client.ClientUtils.ParameterToString(token)); // header parameter


            // make the HTTP request
            var localVarResponse = this.Client.Get<StatisticsGetUserStatisticsResponse>("/v1/statistics/user-stats/bulk/{user_id}", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetBulkUserStatistics", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of StatisticsGetUserStatisticsResponse</returns>
        public async System.Threading.Tasks.Task<StatisticsGetUserStatisticsResponse> GetBulkUserStatisticsAsync(string userId, string keys, string token, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Snapser.Client.ApiResponse<StatisticsGetUserStatisticsResponse> localVarResponse = await GetBulkUserStatisticsWithHttpInfoAsync(userId, keys, token, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (StatisticsGetUserStatisticsResponse)</returns>
        public async System.Threading.Tasks.Task<Snapser.Client.ApiResponse<StatisticsGetUserStatisticsResponse>> GetBulkUserStatisticsWithHttpInfoAsync(string userId, string keys, string token, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
                throw new Snapser.Client.ApiException(400, "Missing required parameter 'userId' when calling StatisticsServiceApi->GetBulkUserStatistics");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<StatisticsGetUserStatisticsResponse>("/v1/statistics/user-stats/bulk/{user_id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
